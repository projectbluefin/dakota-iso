...
| `bluefin` | `ghcr.io/projectbluefin/bluefin-nvidia:stable` | grub2 | no | dormant — manual dispatch only |
| `bluefin-lts-hwe` | `ghcr.io/projectbluefin/bluefin-lts-hwe-nvidia:stable` | grub2 | no | dormant — manual dispatch only |
