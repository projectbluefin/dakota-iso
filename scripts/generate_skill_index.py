...
Output is a pure function of the skill front matter: no timestamps, no host
state. `--check` compares byte-for-byte, so any wall-clock value in the output
would make CI fail on every day except the one the files were regenerated.
"""
...
def find_skill_files() -> list[Path]:
    ...
    files = sorted(p for p in SKILLS_DIR.glob("*.md") if p.name not in ("index.md", "INDEX.md"))
